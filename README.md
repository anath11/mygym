...
# My Gym
My gym is  a fullstack app made out  with laravel at the backend and mysql as a database. The app has three primary user, member, admin and the instructor with certain privilage. Member can book the class, instructor can set up the class and admin can manage and access the class. 
